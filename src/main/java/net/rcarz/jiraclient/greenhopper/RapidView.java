...
public class RapidView extends GreenHopperResource {
	 ...
	 *            REST client instance
	 * @param id
	 *            Internal JIRA ID of the rapid view
	 * 
	...
	public List<Sprint> getSprints() throws JiraException {
		...
		List<Sprint> sprints = GreenHopperField.getResourceArray(Sprint.class, jo.get("sprints"), restclient);
	...
	private List<Sprint> getSprintsWithIssues(List<Sprint> sprints) throws JiraException {
		...
		try {
			for (Sprint sprint : sprints) {
				...
				List<SprintIssue> incomplete = GreenHopperField.getResourceArray(SprintIssue.class,
						content.get("incompletedIssues"), restclient);

				List<SprintIssue> complete = GreenHopperField.getResourceArray(SprintIssue.class,
						content.get("completedIssues"), restclient);
